...
from tensorflow_models.backbones import backbones

from configs import spatio_temporal_action_localization as cfg
from modeling.backbones import vit3d    
from modeling.heads import action_transformer 
from modeling import factory3d as model_factory


@tf_keras.utils.register_keras_serializable(package='Vision')
class VideoActionTransformerModel(tf_keras.Model):
    
    """Video Action Transformer model."""
